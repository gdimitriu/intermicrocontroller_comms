...
void setup() {
  ...
  Wire.begin(0);  // Activate I2C link
...
void receiveHandler(int nrBytes){
  Serial.print("Receive Handler received:");Serial.println(nrBytes);Serial.flush();
  for (int i =0;i<255;i++) {
